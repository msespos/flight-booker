...
Flight.create([{ departure_airport_id: 1, arrival_airport_id: 2,
                 departure_date: '2021-11-01', duration: '1:00' },
               { departure_airport_id: 2, arrival_airport_id: 1,
                 departure_date: '2021-11-02', duration: '2:00' },
               { departure_airport_id: 3, arrival_airport_id: 4,
                 departure_date: '2021-11-03', duration: '3:00' },
               { departure_airport_id: 4, arrival_airport_id: 3,
                 departure_date: '2021-11-04', duration: '4:00' },
